    ...
    <div className="flex justify-between items-center  container mx-auto mt-5">
      <div >
        <h1 className="text-6xl font-bold pb-4">
          Build Your Ideal <br />
          <span className="text-[#7C3AED]">Development Stack</span>
        </h1>
        ...
        <div className="flex gap-4 items-center pt-7">
            <button className="rounded-[8px] bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] px-3 py-2 text-white">Explore Technologies</button>
            <button className=" rounded-[8px] inset-shadow-2xs shadow-md px-8 py-2">Learn More</button>
        </div>
      </div>
